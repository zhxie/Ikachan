...
class ShiftIntentHandler: IntentHandler, ShiftIntentHandling {
    ...
    func handle(intent: ShiftIntent, completion: @escaping (ShiftIntentResponse) -> Void) {
        fetchShifts { (shifts, error) in
            ...
            let result = String(format: formatter.localizedIntentsString, shift.stage!.description.rawValue.localizedIntentsString, shift.weapons[0].description.rawValue.localizedIntentsString, shift.weapons[1].description.rawValue.localizedIntentsString, shift.weapons[2].description.rawValue.localizedIntentsString, shift.weapons[3].description.rawValue.localizedIntentsString, absoluteLongIntentsTimeSpan(current: Date(), startTime: shift.startTime, endTime: shift.endTime))
