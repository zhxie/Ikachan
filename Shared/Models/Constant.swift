...
let PreviewSplatoon3Shift = Splatoon3Shift(startTime: Date(), endTime: Calendar.current.date(byAdding: .day, value: 1, to: Date())!, mode: .salmonRun, stage: PreviewStage, weapons: [PreviewWeapon, PreviewWeapon, PreviewWeapon, PreviewWeapon], kingSalmonid: "Cohozuna")
...
let MaxShiftWidgetEntryCount = 6
